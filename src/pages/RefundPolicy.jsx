...
const RefundPolicy = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:3000/api/refund-policy/getRefundPolicy');
                if (response.data) {
                    setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/refund-policy/update', updatedFormData);
