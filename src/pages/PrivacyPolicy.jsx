...
const PrivacyPolicy = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:3000/api/privacy-policy/getPrivacyPolicy');
                if (response.data) {
                    setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/privacy-policy/update', updatedFormData);
